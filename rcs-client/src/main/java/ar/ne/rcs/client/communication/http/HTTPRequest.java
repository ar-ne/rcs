...
public class HTTPRequest {
     ...
     */
    public static <T> int PostObject(String url, T data) throws IOException {
     ...
     */
    public static <T> T GetObject(String url, List<RequestParam> params, Class<T> classOfT) throws IOException {
        return new GsonBuilder().setDateFormat("yyyy-MM-dd'T'HH:mm:ss").create().fromJson(GetString(url, params), classOfT);
    }

    public static String GetString(String url, @Nullable List<RequestParam> params) throws IOException {
        Request request = new Request.Builder()
